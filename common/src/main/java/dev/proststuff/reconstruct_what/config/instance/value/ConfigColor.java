...
public class ConfigColor extends ConfigValue<Color> {
    public ConfigColor(String name, Color color, boolean runtimeOnly) {
        super(name, color, ConfigCodecs.COLOR, runtimeOnly);
    }

    public ConfigColor(String name, Color color) {
