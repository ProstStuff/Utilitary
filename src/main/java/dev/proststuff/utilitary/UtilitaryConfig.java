...
import dev.proststuff.utilitary.config.v1.serialization.format.Json5ConfigFormat;
import dev.proststuff.utilitary.config.v1.serialization.metadata.SimpleMetadataType;
